...
import id.zainalfahrudin.orbit.job9.AdapterRecyclerView;
import android.support.v7.widget.RecyclerView;
import android.view.View;
import android.widget.AdapterView;
import android.widget.ListView;

public class BelajarRecyclerView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.rvData);
        ...
        AdapterRecyclerView mAdapter = new AdapterRecyclerView(data, this, new AdapterRecyclerView.OnItemClickListener() {
            @Override
            public void onItemClick(DataModel item) {
                Snackbar.make(mRecyclerView, item.getNama_os(), Snackbar.LENGTH_SHORT).show();
            }
        });
